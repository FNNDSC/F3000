...
if [ -z "$6" ]
then
  echo "USAGE: `basename $0` {FREESURFER_DIR} {DIFFUSION_DICOM_DIR} {OUTPUT_DIR} {S_OUTPUT_DIR} {DECLEVEL} {RADIUS} [-v]"
  exit 1
fi
...
#
S_OUTPUT_DIR=$4
SUPER_DECIMATION_LEVEL=$5
RADIUS=$6
./fy_supersurfaceconnectivity.py -i $FIBERS_TO_BRAIN_MAPPED_FILE -b $BRAIN_FILE -lh $LEFT_HEMI_FILE -rh $RIGHT_HEMI_FILE -d $SUPER_DECIMATION_LEVEL -r $RADIUS -o $S_OUTPUT_DIR $VERBOSE
