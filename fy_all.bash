...
#
LEFT_HEMI=$OUTPUT_DIR/lh.smoothwm
RIGHT_HEMI=$OUTPUT_DIR/rh.smoothwm
FIBERS_WITH_VERTICES=$OUTPUT_DIR/fibers_with_vertices.trk
DECIMATION_LEVEL=0.333

./fy_surfacemap.py -i $FIBERS_TO_BRAIN_MAPPED_FILE -b $BRAIN_FILE -lh $LEFT_HEMI -rh $RIGHT_HEMI -o $FIBERS_WITH_VERTICES -d $DECIMATION_LEVEL $VERBOSE
